...
$sql = "SELECT * FROM banco_reacciones ORDER BY codigo;";//descripcion
...
$OpcionesSelect = " id='popReacciones' " ;
$list = new PopUp($codigos_bact, $nombres_bact, "Reacciones", "", "Reacciones", 1, 350, $OpcionesSelect);
