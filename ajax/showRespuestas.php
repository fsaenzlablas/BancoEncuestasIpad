...
if ($donante != "") {
    ...
    $_SESSION[$num_ot]['codigos_pre']=array();
    $_SESSION[$num_ot]['descripciones']=array();
    $_SESSION[$num_ot]['tipos']=array();
    $_SESSION[$num_ot]['rdonante']=array();
    ...
    if ($respuestas = $db->get_results($sql, ARRAY_A)) {
        ...
        foreach ($respuestas as $resp) {
            ...
            array_push($_SESSION[$num_ot]['codigos_pre'], $resp['codigo']);
            array_push($_SESSION[$num_ot]['descripciones'], $resp['descripcion']);
            array_push($_SESSION[$num_ot]['tipos'], $resp['tipo']);
            array_push($_SESSION[$num_ot]['rdonante'], $resp['valor']);
